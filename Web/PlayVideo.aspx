                ...
                <div style="margin-top: 10px; font-family: 'Microsoft YaHei';">
                     <div id="left" style="width: 68%; border-right: 2px solid #e3e3e5; float: left; overflow: hidden; margin-right: 0px; margin-bottom:-3000px; padding-bottom:3000px;">
                        ...
                        <div style="text-align: center; color: #2b2b2b; font-size: 18px;">
                            <asp:Label ID="txtTitle" runat="server" Text='<%#Eval("v_title") %>' ForeColor="#2b2b2b" Font-Size="18"></asp:Label>
                        </div>
                        <div style="text-align: center; padding: 5px; font-size: 14px; font-family: 'Microsoft YaHei'; color: #555555;">
                            ...
                            <span style="border-left: 2px solid #cccccc; padding-left: 10px; padding-right: 10px;">点击量：<asp:Label ID="txtClickNum" runat="server" Text="0"></asp:Label>
                            </span>
                            <span style="border-left: 2px solid #cccccc; padding-left: 10px; padding-right: 10px;">下载量：<asp:Label ID="txtDownLoadNum" runat="server" Text="0"></asp:Label>
                            </span>
